            ...
            <ScrollView contentContainerStyle={styles.cardsContainer}>
                {selectedTab === 'Incoming' && (
                    <View style={[styles.card]}>
                        ...
                        <View style={styles.cardContent}>
                            <Text style={[styles.cardTitle, { color: isDarkMode ? '#FFF' : '#000' }]}>Maryland Winkles</Text>
                            <Text style={[styles.cardStatus, { color: isDarkMode ? '#FFF' : '#000' }]}>Home Management</Text>
                ...
                {selectedTab === 'Cancelled' && (
                    <View style={styles.card}>
                        <Image source={require('D:/beatask/src/assets/images/category/booked.png')} style={styles.cardImage} />
                        <View style={styles.cardContent}>
                            <Text style={[styles.cardTitle1, { color: isDarkMode ? '#FF0000' : '#FF0000' }]}>Maryland Winkles</Text>
                            <Text style={[styles.cardStatus1, { color: isDarkMode ? '#FF0000' : '#FF0000' }]}>Home Management</Text>
                            <Text style={[styles.cardSubtitle1, { color: isDarkMode ? '#FF0000' : '#FF0000' }]}>Residential cleaning service</Text>
                            <View style={styles.cardFooter}>
                                <Text style={[styles.cardDate, { color: isDarkMode ? '#FF0000' : '#FF0000' }]}>On 20-06-2024</Text>
                            </View>
                        </View>
                        <TouchableOpacity style={styles.chatButton} onPress={handlechat}>
                            <Icon name="chat-processing-outline" size={wp('7%')} color={isDarkMode ? '#FFF' : '#000'} />
