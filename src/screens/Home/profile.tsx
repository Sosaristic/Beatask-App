            ...
            <ScrollView contentContainerStyle={[styles.container, isDarkMode && styles.darkContainer]}>
                {sections.map((section) => (
                    <View key={section} style={styles.sectionContainer}>
                        ...
                        {expandedSections.includes(section) && section === 'Profile Setup' && (
                            ...
                            />
                                ...
                                <View style={styles.phoneContainer}>
                                    ...
                                    <TextInput
                                        style={[styles.input, styles.phoneInput, isDarkMode && styles.darkInput]}
                        ...
                        {expandedSections.includes(section) && section === 'App setting' && (
                             <View style={[styles.detailsContainer,isDarkMode && styles.darkdetailsContainer]}>
                ...
                <TouchableOpacity onPress={handleService} style={[styles.section2, isDarkMode && styles.darkSection]}>
                    <Text style={[styles.sectionText, isDarkMode && styles.darkSectionText]}>Saved providers</Text>
                    <FontAwesomeIcon
                        name={'chevron-right'}
                        size={wp('6%')}
                        style={[styles.chevron, isDarkMode && styles.darkChevron]}
