...
import { View, TextInput, StyleSheet, Text, ScrollView, TouchableOpacity, useColorScheme, Image } from 'react-native';
...
const CreateAccountScreen = () => {
    ...
    return (
        <ScrollView contentContainerStyle={[styles.container, { backgroundColor: colorScheme === 'dark' ? '#010A0C' : '#FFFFFF' }]}>
            <TouchableOpacity onPress={pickImage}>
                <View style={styles.imageContainer}>
                    {imageUri ? (
                        <Image source={{ uri: imageUri }} style={styles.image} />
                    ) : (
                        <Image source={require('D:/beatask/src/assets/images/category/user.png')} style={styles.image} />
                    )}
                    <Icon name="pencil" size={24} color={colorScheme === 'dark' ? "#12CCB7" : "#12CCB7"} style={styles.icon} />
                </View>
            </TouchableOpacity>
